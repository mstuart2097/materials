...
Now we would like to repeat this modelling approach to all countries, i.e. *split* by movie, *apply* the model, *combine* the results. 
...
- Extract residuals and fitted values for each of the models and store them in a dataset together with country and continent information. Draw a scatterplot of predicted Life Expectancy in 2017 versus slope. Compare this to the scatterplot of Intercept versus slope.
