...
... lots of these mis-located items are on the last day of the year:

```{r}
campaign %>% filter(!inIA, State == "IA", round(long,5)==-93.92181) %>% select(Date, `Committee Name`) %>% xtabs(data=., ~`Date`) %>% sort()
```
