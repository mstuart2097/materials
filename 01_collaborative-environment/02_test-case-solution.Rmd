...
```{r message = FALSE}
iowa <- readr::read_csv("data/brfss_iowa.csv") 
...
<img src="images/codebook-height3.png" width=750>
...
- this slide deck is rendered from an R Markdown document, located at []().
