...
1. Summarize the changes that you have made in 50 characters or less and click the <span style="background:darkgreen; color:white"> commit </span>    button. 
...
2.  Click the  <span style="background:darkgreen; color:white">New Pull Request</span> button. You will get an overview of the changes you made to the repository. 
